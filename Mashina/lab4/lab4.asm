...
DATA SEGMENT
    alreadyLoaded db 'The interruption has already been loaded.',0DH,0AH,'$'
    UnLoaded db 'The interruption has been unloaded.',0DH,0AH,'$'
    Loaded db 'The interruption has Loaded.',0DH,0AH,'$'
DATA ENDS
